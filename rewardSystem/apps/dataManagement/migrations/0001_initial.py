# Generated by Django 2.2 on 2020-03-17 14:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('etcImage', models.ImageField(blank=True, upload_to='ETCImage', verbose_name='四级/六级图片')),
                ...
                ('activity', models.BooleanField(default=False, verbose_name='是否通过审核')),
            ],
            options={
                'verbose_name': '申请表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('socialWork', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_socialWorkImage', to='dataManagement.ApplicationForm')),
            ],
            options={
                'verbose_name': '社会服务文件',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('researchProjects', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_researchProjectsImage', to='dataManagement.ApplicationForm')),
            ],
            options={
                'verbose_name': '参与项目文件',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publications', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_publicationsImage', to='dataManagement.ApplicationForm')),
            ],
            options={
                'verbose_name': '发表论文文件',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('publicationsImage', models.ImageField(upload_to='participateItemsImage', verbose_name='相关图片')),
                ('participateItems', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_participateItemsImage', to='dataManagement.ApplicationForm')),
            ],
            options={
                'verbose_name': '参与项目文件',
                'verbose_name_plural': '参与项目文件',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jury', models.ManyToManyField(blank=True, to='dataManagement.Teacher', verbose_name='评委老师')),
                ('student', models.ManyToManyField(blank=True, to='dataManagement.Student', verbose_name='参与学生')),
            ],
            options={
                'verbose_name': '评审会议',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('innovationProjects', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_innovationProjectsImage', to='dataManagement.ApplicationForm')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuTable', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dataManagement.FuTable')),
            ],
            options={
                'verbose_name': '赋分项列表',
        ...
        migrations.AddField(
            model_name='applicationform',
            name='jury',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='dataManagement.Teacher', verbose_name='评委'),
        ),
        migrations.AddField(
            model_name='applicationform',
            name='meeting',
